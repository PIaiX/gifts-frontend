                        ...
                        <Col xs={12} sm={10} md={8} lg={6}>
                            <form>
                                ...
                                <div className="d-flex align-items-center justify-content-center">
                                    <Link to="/account" className="btn-1 fs-11 px-5">
                                        Войти
                                    </Link>
                                    <Link to="/reset-password" className="blue ms-3">
                                        Забыли пароль?
                                    </Link>
                                </div>
                                <div className="text-center mt-3">
                                    У вас нет аккаунта?{' '}
                                    <Link to="/registration" className="main-color text-decoration-underline">
                                        Зарегистрироваться
                                    </Link>
                                </div>
                            </form>
