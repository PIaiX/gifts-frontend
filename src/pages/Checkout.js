            ...
            <Container>
                ...
                <section className="mb-8">
                    ...
                    <Row xs={1} md={2} xl={3} className="g-4 g-xxl-5 mb-4">
                        <Col>
                            <div className="box p-3 p-sm-4">
                                <form>
                                    <h3 className="text-start fs-20 fw-6 mb-4">
                                        Авторизуйтесь или зарегестрируйтесь
                                    </h3>
                                    ...
                                    <button type="button" className="btn-1 w-100 mt-3">
                                        Войти
                                    </button>
                                    <div className="fw-6 mt-3">
                                        Ещё нет аккаунта?{' '}
                        ...
                        <Col>
                            <div className="box p-3 p-sm-4">
                                <form>
                                    ...
                                    <div className="fs-08 fw-3 text-center mt-3">
                        ...
                        <Col>
                            <div className="box p-3 p-sm-4">
                                ...
                                <div className="fw-6 mb-4 mb-sm-5">
                                    <Link to="/" className="main-color text-decoration-underline">
                                        Авторизируйтесь
                                    </Link>{' '}
                                    и получите 253 Балла
                                </div>
                    ...
                    <form className="mb-4">
                        <Row xs={1} md={2}>
                            <Col>
                                <fieldset className="box p-3 p-sm-4">
                                    <div>
                                        Имя <span className="main-color">*</span>
                                    </div>
                                    <input type="text" placeholder="Ваше имя" className="mt-2" />

                                    <div className="mt-3">
                                        Фамилия <span className="main-color">*</span>
                                    </div>
                                    <input type="text" placeholder="Ваше имя" className="mt-2" />

                                    <div className="mt-3">
                                        Введите номер телефона <span className="main-color">*</span>
                                    </div>
                                    <input type="tel" placeholder="+7 (965) 345-67-89" className="mt-2" />

                                    <div className="mt-3">
                                        Введите e-mail <span className="main-color">*</span>
                                    </div>
                                    <input type="email" placeholder="Ваш e-mail" className="mt-2" />

                                    <div className="mt-3">
                                        Город <span className="main-color">*</span>
                                    </div>
                                    <input type="text" placeholder="Город" className="mt-2" />

                                    <div className="mt-3">
                                        Адрес доставки <span className="main-color">*</span>
                                    </div>
                            ...
                            <Col>
                                <fieldset className="box p-3 p-sm-4 mb-4 mt-4 mt-md-0">
                                    <legend className="d-block mb-3 mb-sm-4">
                                        Способ доставки <span className="main-color">*</span>
                                    </legend>
                                    ...
                                    <label className="mt-4">
                                        ...
                                        <span>
                                            Самовывоз{' '}
                                            <span className="fs-08 gray">
                                                (адреса магазинова в разделе Контакты)
                                            </span>
                                        </span>
                                    </label>
                                    <label className="mt-4">
                                    ...
                                    <label className="mt-4">
                                        <input type="radio" name="delivery" />
                                        <span>
                                            CDEK (полная предоплата){' '}
                                            <span className="fs-08 gray">
                                                цена доставки рассчитывается по тарифам CDEK
                                            </span>
                                        </span>
                                    </label>
                                    <label className="mt-4">
                                        <input type="radio" name="delivery" />
                                        <span>
                                            Почта России (полная предоплата){' '}
                                            <span className="fs-08 gray">
                                                цена доставки рассчитывается по тарифам почты России
                                            </span>
                                        </span>
                                    </label>
                                </fieldset>
                                <fieldset className="box p-3 p-sm-4">
                                    <legend className="d-block mb-3 mb-sm-4">
                                        Способ оплаты <span className="main-color">*</span>
                                    </legend>
                                    <label className="mt-4">
                                    ...
                                    <label className="mt-4">
                                        ...
                                        <span>
                                            Наличный расчёт{' '}
                                            <span className="fs-08 gray">(Действует только на самовывоз)</span>
                                        </span>
                                    </label>
                                    <label className="mt-4">
                                        <input type="radio" name="payment" />
                        ...
                        <button type="submit" className="btn-1 mt-4 px-5">
                            Отправить заказ
                        </button>
                    ...
                    <Row className="justify-content-center">
                        <Col xs={12} md={8} lg={6} xxl={5}>
                            <h3 className="text-center">
                                Мы приняли ваш заказ и в скором времени свяжемся с вами для его подтверждения
                            </h3>
                            <h4 className="text-center mt-3 mt-sm-4">
                                Номер заказа: <span className="main-color">123456</span>
                            </h4>
                            <p className="text-center mb-3 mb-sm-4">
                                Письмо с подтверждением заказа отправлено на адрес вашей электронной почты
                            </p>
                            <p className="text-center mb-3 mb-sm-4">
                                Если у вас возникли вопросы вы можете позвонить нам по телефону:{' '}
                                <a href="tel:+79172854275">+7 (917) 285-42-75</a>
                            </p>
