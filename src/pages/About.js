                ...
                <section className="company-sec mb-8">
                    <Row className="gy-4 gy-md-5">
                        <Col xs={12} lg={6} xxl={5}>
                            ...
                            <div className="text">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dolor justo lectus
                                    mauris pulvinar pulvinar ornare ante felis. Quis tellus mauris sed phasellus elit
                                    aliquam. Accumsan, varius ornare facilisis ac. Arcu commodo sem dui a vestibulum,
                                    senectus augue a. Molestie aenean nisl sit id aliquam a, eu molestie eu. Ipsum
                                    adipiscing sagittis, gravida facilisi. Ut donec et est nec ullamcorper enim sed
                                    vitae massa. Nulla fames pretium ut nulla a. Sed eu in proin nullam gravida. Ac
                                    eget a aliquam porttitor libero tristique. Fames donec neque porttitor tellus.
                                    Velit morbi mauris sit massa purus velit commodo. Cras enim augue urna, in cursus
                                    nulla praesent.
                                </p>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dolor justo lectus
                            ...
                            <form className="mt-4">
                                <Row className="g-3">
                                    ...
                                    <Col md={{span: 4, offset: 8}}>
                                        <div className="flex-1 text-center fs-08 fw-3">
