                ...
                <Col md={7}>
                    <form className="fs-12">
                        ...
                        <label className="mb-2">
                            Ваш город <span className="main-color">*</span>
                        </label>
                        <input className="mb-4" type="text" placeholder="Город" />
                        <label className="mb-2">
                            Улица <span className="main-color">*</span>
                        </label>
                        <input className="mb-4" type="text" placeholder="Улица" />
                        <label className="mb-2">
                            Дом <span className="main-color">*</span>
                        </label>
                        <input className="mb-4" type="number" placeholder="0" />
                        <label className="mb-2">
                            Квартира <span className="main-color">*</span>
                        </label>
                        <input className="mb-4" type="number" placeholder="0" />
                        ...
                        <Row md={2} className="gy-3">
                            ...
                            <Col>
                                <Link to="/account/addresses" className="btn-2 w-100">
                                    Отменить
                                </Link>
                            </Col>
                        </Row>
