    ...
    return (
        <div className="box p-4 p-xl-5">
            ...
            <ul className="list-unstyled fs-12 mb-4">
                ...
                <li className="mb-3">
                    <a href="tel:+79378456123">+79378456123</a>
                </li>
                <li className="mb-3">
                    <a href="mailto:natya@gmail.com">natya@gmail.com</a>
                </li>
                <li className="mb-3">Казань</li>
            </ul>

            <div className="d-sm-flex align-items-center">
                <Link to="edit" className="btn-1">
                    Редактировать
                </Link>
                <Link to="password" className="btn-1 ms-sm-4 mt-3 mt-sm-0">
                    Изменить пароль
                </Link>
            </div>
        </div>
