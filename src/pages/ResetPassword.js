                                ...
                                <form>
                                    ...
                                    <div className="form-group">
                                        <input
                                            ...
                                            className="py-3 px-4"
                                        />
                                        <button type="button" className="btn-1" onClick={() => setStep('2')}>
                                            Получить код
                                        </button>
                                    </div>
                                </form>
                                ...
                                <form>
                                    ...
                                    <div className="form-group">
                                        <input
                                            ...
                                            className="py-3 px-4"
                                        />
                                        <button type="button" className="btn-1" onClick={() => setStep('3')}>
                                            Отправить
                                        </button>
                                    </div>
                                </form>
                            ...
                            {step === '3' && (
                                <form>
                                    ...
                                    <InputPassword
                                        ...
                                        className="mb-4"
                                    />
                                    <button type="button" className="btn-1 fs-11 px-5 mx-auto">
                                        Сохранить
                                    </button>
                                </form>
                            )}
