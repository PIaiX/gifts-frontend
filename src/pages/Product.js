        ...
        <main className="product-mobile">
            {mobile && (
                <>
                    <div className="product-full-top">
                        <Swiper loop={false} spaceBetween={20} modules={[Pagination]} pagination={{clickable: true}}>
                            <SwiperSlide>
                        ...
                        <Link to="/catalog/category/list" className="back">
                            <FiArrowLeft />
                        </Link>
                        <div className="btns">
                ...
                <section className="product-full mb-8">
                    {mobile ? (
                        <div className="pt-4">
                                ...
                                <Offcanvas show={showReviews} placement={'end'} onHide={handleCloseReviews}>
                                    <Offcanvas.Body>
                                        ...
                                        <form className="mb-4">
                                            ...
                                            <button type="button" className="btn-1 mt-3">
                                                Оставить отзыв
                                            </button>
                                        </form>
                                        ...
                                        <Review
                                            rate={4}
                                            text={
                                                'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem nec id eleifend non tincidunt lectus pellentesque ac. Auctor enim nunc, diam cras nec eleifend felis. Augue at adipiscing et molestie neque non. Pulvinar est ac malesuada amet.'
                                            }
                                            name={'Анастасия Гоначарова'}
                                            date={'14.07.2022'}
                                        />
                                        <Review
                                            rate={5}
                            ...
                            <div className="box">
                                <div className="fs-11">
                                    Доставка в <strong className="main-color">Казань</strong>
                                </div>
                            ...
                            <p className="mb-2">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dolor justo lectus mauris
                                pulvinar pulvinar ornare ante felis. Quis tellus mauris sed phasellus elit aliquam.
                                Accumsan, varius ornare facilisis ac. Arcu commodo sem dui a vestibulum, senectus
                                augue a. Molestie aenean nisl sit id aliquam a, eu molestie eu. Ipsum adipiscing
                                sagittis, gravida facilisi. Ut donec et est nec ullamcorper enim sed vitae massa.
                                Nulla fames pretium ut nulla a. Sed eu in proin nullam gravida. Ac eget a aliquam
                                porttitor libero tristique. Fames donec neque porttitor tellus. Velit morbi mauris
                                sit massa purus velit commodo. Cras enim augue urna, in cursus nulla praesent.
                            </p>
                            <h6 className="mb-2">Lorem ipsum dolor</h6>
                            <p className="mb-2">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dolor justo lectus mauris
                                    ...
                                    <Row className="gx-3 gx-xl-4 justify-content-between">
                                        <Col sm={7}>
                                            <div className="box mb-4 mb-sm-0">
                                                ...
                                                <button
                                                    type="button"
                                                    className="main-color fs-08 text-decoration-underline w-100 text-start mt-2"
                                                >
                                                    Все характеристики
                                                </button>
                                                <button
                                        ...
                                        <Col sm={5} xxl={4}>
                                            ...
                                            <p className="fs-09">
                                                По Казани осуществляется по договорённости с курьером. Минимальная
                                                сумма заказа <span className="black fw-6">400 ₽</span>
                                            </p>
                                            <p className="fs-09 mt-2">
                                                По России через компанию <span className="black fw-6">CDEK</span> или{' '}
                                                <span className="black fw-6">почтой России</span>
                                            </p>
                                            <hr className="my-3" />
                                            <div className="fw-6 mb-2">Самовывоз:</div>
                                            <p className="fs-09">
                                                Магазин по адресу: Татарстан, Казань, Рашида Вагапова 3
                                            </p>
                                            <hr className="my-3" />
                                    ...
                                    <div className="box">
                                        <div className="tabs">
                                            ...
                                            <button
                                                ...
                                                onClick={() => setTab('3')}
                                            >
                                                Отзывы <span className="gray fs-08 fw-4">(110)</span>
                                            </button>
                                        </div>
                                        {tab === '1' && (
                                            <div className="tabs-content">
                                                ...
                                                <p>
                                                    ...
                                                    justo lectus mauris pulvinar pulvinar ornare ante felis. Quis
                                                    tellus mauris sed phasellus elit aliquam. Accumsan, varius ornare
                                                    facilisis ac. Arcu commodo sem dui a vestibulum, senectus augue
                                                    a. Molestie aenean nisl sit id aliquam a, eu molestie eu. Ipsum
                                                    adipiscing sagittis, gravida facilisi. Ut donec et est nec
                                                    ullamcorper enim sed vitae massa. Nulla fames pretium ut nulla a.
                                                    Sed eu in proin nullam gravida. Ac eget a aliquam porttitor
                                                    libero tristique. Fames donec neque porttitor tellus. Velit morbi
                                                    mauris sit massa purus velit commodo. Cras enim augue urna, in
                                                    cursus nulla praesent.
                                                </p>
                                                <h6>Lorem ipsum dolor</h6>
                                                <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dolor
            ...
            {mobile && (
                <div className="mobile-cart-btn">
                    <button type="button" onClick={() => handleShowAlert()} className="btn-1 w-100">
                        В корзину 3000 руб.
                    </button>
                </div>
            )}
