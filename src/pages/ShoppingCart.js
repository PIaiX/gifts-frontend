                                ...
                                <Col>
                                    <div className="box p-3 p-sm-4">
                                        ...
                                        <div className="fw-6 mb-4 mb-sm-5">
                                            ...
                                            и получите 253 Балла за этот заказ
                                        </div>
                                        ...
                                        <Link to="checkout" className="btn-1 w-100 mt-3 mt-sm-4">
                                ...
                                <Col>
                                    <div className="box p-3 p-sm-4">
                                        ...
                                        <div className="my-3">
                                            ...
                                            <span className="main-color fs-13 fw-6">550 Б</span>
                                        </div>
                                        <div className="gray fs-09 mb-2">
                                            Введите количество баллов, которые хотите использовать:
                                        </div>
                                        <div className="form-group">
                                            <input type="number" placeholder="0" />
                                            <button type="button" className="btn-1 fs-15 py-2 py-lg-3 px-4">
                                                <FiArrowRight />
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="box p-3 p-sm-4">
                                        ...
                                        <figure className="product-card-horizontal mt-3 mt-sm-4">
                                            <img
                                                ...
                                                alt='Термостакан со вставкой "Эспрессо Патронум...'
                                            />
                                            <figcaption>
                                                <h6 className="fs-10 fw-4 mb-2">
                                                    Термостакан со вставкой "Эспрессо Патронум...
                                                </h6>
                                        ...
                                        <button type="button" className="btn-2 w-100 mt-3 mt-sm-4">
                                            Добавить в корзину
                                        </button>
                                    </div>
                                </Col>
