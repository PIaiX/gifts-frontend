        ...
        <>
                ...
                <div className="top">
                    <Container className="d-flex align-items-center justify-content-between h-100">
                        ...
                        <div className="d-flex">
                            <button type="button" className="main-color text-decoration-underline me-3">
                                Заказать звонок
                            </button>
                            <a href="tel:+79653456789" className="fw-6">
                                +7 (965) 345-67-89
                            </a>
                        </div>
                    </Container>
                ...
                <Container>
                    ...
                    <nav className="main">
                        <ul>
                            ...
                            <li>
                                <NavLink to="/returns">Возврат</NavLink>
                            </li>
                            <li>
                                <NavLink to="/all-news">Новости</NavLink>
                            </li>
                            <li>
            ...
            <Offcanvas show={show} onHide={handleClose}>
                <Offcanvas.Body>
                    ...
                    <button type="button" className="main-color text-decoration-underline fs-12 mb-3">
                        Заказать звонок
                    </button>
                    <a href="tel:+79653456789" className="fw-6 fs-17">
                        +7 (965) 345-67-89
                    </a>
                </Offcanvas.Body>
            </Offcanvas>
