            ...
            <Container>
                <Row className="desktop g-4 g-xl-5">
                    ...
                    <Col md={3}>
                        ...
                        <p className="fw-3 fs-09 mb-3">
                            Подпишитесь на новостную рассылку, чтобы быть в курсе новинок, свежих акций и самых
                    ...
                    <Col md={3}>
                        ...
                        <ul className="list-unstyled">
                            <li className="d-flex">
                                ...
                                <address className="flex-1 ms-2">
                                    Татарстан, г.Казань, ул. Рашида Вагапова д.3
                                </address>
                            </li>
                            <li className="d-flex">
                            ...
                            <li className="d-flex">
                                ...
                                <div className="flex-1 ms-2">
                                    <a href="mailto:eshop-gift@mail.ru">eshop-gift@mail.ru</a>
                                </div>
                            </li>
                        </ul>
                    </Col>
